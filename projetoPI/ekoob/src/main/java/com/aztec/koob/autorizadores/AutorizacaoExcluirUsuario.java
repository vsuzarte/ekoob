 ...
 * @author Gabriel
 */
@WebFilter(filterName = "AutorizacaoExcluirUsuario", 
        servletNames = {"ExcluirUsuarioServlet"},
        urlPatterns = {"/consultarUsuario.jsp*"})
public class AutorizacaoExcluirUsuario implements Filter {
