 ...
 */
    ...
    CREATE TABLE Usuario (
        ...
        dataNasc DATE NOT NULL DEFAULT '1996-10-28' ,
    ...
    CREATE TABLE Venda (
        ...
        /*FOREIGN KEY (valorTotal) REFERENCES Produto(valorProduto)*/
);
    ...
    CREATE TABLE Fornecedor (
        idFornecedor INTEGER PRIMARY KEY GENERATED ALWAYS AS IDENTITY (START WITH 1, INCREMENT BY 1),
...
INSERT INTO USUARIO(NOMEUSUARIO,SOBRENOMEUSUARIO,FUNCAO,DATANASC,CPFUSUARIO,EMAILUSUARIO,TELEFONEUSUARIO,ESTADOUSUARIO,CIDADEUSUARIO,ENDERECOUSUARIO,CEPUSUARIO,USERNAME,SENHA,DISPONIVEL) VALUES ('ADMIN','ADMIN','gerente','1999-01-01','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN',TRUE);
INSERT INTO USUARIO(NOMEUSUARIO,SOBRENOMEUSUARIO,FUNCAO,DATANASC,CPFUSUARIO,EMAILUSUARIO,TELEFONEUSUARIO,ESTADOUSUARIO,CIDADEUSUARIO,ENDERECOUSUARIO,CEPUSUARIO,USERNAME,SENHA,DISPONIVEL) VALUES ('VENDEDOR','VENDEDOR','vendedor','1999-01-01','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR',TRUE);
