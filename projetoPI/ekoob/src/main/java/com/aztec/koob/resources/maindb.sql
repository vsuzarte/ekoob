...
INSERT INTO USUARIO(NOMEUSUARIO,SOBRENOMEUSUARIO,FUNCAO,DATANASC,CPFUSUARIO,EMAILUSUARIO,TELEFONEUSUARIO,ESTADOUSUARIO,CIDADEUSUARIO,ENDERECOUSUARIO,CEPUSUARIO,USERNAME,SENHA,DISPONIVEL) VALUES ('ADMIN','ADMIN','gerente','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN','ADMIN',TRUE);
INSERT INTO USUARIO(NOMEUSUARIO,SOBRENOMEUSUARIO,FUNCAO,DATANASC,CPFUSUARIO,EMAILUSUARIO,TELEFONEUSUARIO,ESTADOUSUARIO,CIDADEUSUARIO,ENDERECOUSUARIO,CEPUSUARIO,USERNAME,SENHA,DISPONIVEL) VALUES ('VENDEDOR','VENDEDOR','vendedor','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR','VENDEDOR',TRUE);
