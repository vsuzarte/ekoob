        ...
        <div id="box" class="container-fluid">
            <div class="container">
                <div class="formBox">
                    ...
                    <form action="${pageContext.request.contextPath}/editar-produto" method="post">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <input type="text" maxlength="50" size="50" name="idProduto" class="input required" id="fnome" value = "${idProduto}">
