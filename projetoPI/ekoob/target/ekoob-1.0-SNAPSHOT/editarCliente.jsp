        ...
        <div id="box" class="container-fluid">
            <div class="container">
                <div class="formBox">
                    ...
                    <form id="registerform" name="registerform" action="${pageContext.request.contextPath}/editar-cliente" method="post">
                        <div class="row">
                            <div class="col-sm-12">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <input type="hidden" maxlength="50" size="50" name="id" class="input required" id="fnome" value ="${id}">
                                    <div class="inputBox">
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input type="text" maxlength="50" size="50" name="sobrenome" class="input required" id="fnome" value ="${sobrenome}">
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input id="cpf" type="number" maxlength="11" size="11" name="cpf" class="input required" value ="${cpf}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input type="text" name="email" class="input required email" value ="${email}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input type="number" maxlength="12" size="12" name="telefone" class="input required " value ="${telefone}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input id="cep" type="number" maxlength="8" size="8" name="cep" class="input required " value ="${cep}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input id="rua" type="text" name="endereco" class="input required " value ="${endereco}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input id="cidade" type="text" name="cidade" class="input required " value ="${cidade}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input id="uf" type="text" name="estado" class="input required " value ="${estado}">
                                    </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="inputBox">
                                        ...
                                        <input  type="number" name="numero" class="input required " value ="${numero}">
                                    </div>
