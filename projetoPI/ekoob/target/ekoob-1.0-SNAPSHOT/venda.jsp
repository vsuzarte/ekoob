            ...
            <div class="row">
                ...
                <div id="bodyvenda" class="col-md-6">
                    <div id="cont" class="container">
                        <div class="centro">
                            <h3>Venda</h3>
                            <form action="${pageContext.request.contextPath}/adicionar-item-venda" >
                                <div class="inputBox">
                                ...
                                <div class="inputBox"> 
                                    ...
                                    <input name = "quantidade" type="number" placeholder="Quantidade desejada"/>
                        ...
                        <div id="cont" class="container">
                            <div class="centro">
                                <div class="inputBox"> 
                                    ...
                                    <form action="${pageContext.request.contextPath}/finalizar-venda" method="post">
                                    <input  type="submit" name="" value="Finalizar">
                                    </form>
